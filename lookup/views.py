...
def home(request):
    ...
    if request.method == "POST":
        ...
        api_request = requests.get(
            "http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode="+ zipcode +"&distance=25&API_KEY=FAAC95B6-1538-41E7-9EDF-0CA843DF78F2")
        try:
